...
floor_moving_down_1 = floor_pos_1[1] + 40
floor_moving_down_2 = floor_pos_2[1] + 40
floor_moving_down_3 = floor_pos_3[1] + 40
...
while True:
    ...
    if state == "moving_down" and pos[1] >= pos_tpl[1]:
